...
angular.module('sbAdminApp')
        .controller('EmbalagemCtrl', ['$scope', '$position','ModalService', '$http', 
        function ($scope, $position, ModalService, $http) {
...
//            carregarEmbalagensAPI();
            ...
            function carregarEmbalagensAPI(){
                ...
                $http.get('http://192.168.43.163:11392/SGI/embalagem/'
...
//                $scope.embalagem = {id: "", dsCurta: "", dsDetalhada: "", material: "", imagem: "", dimensoes: ""};
            ...
            function ($scope, $element, $http, close, iconeHeaderDialog, tituloDialog, embalagem, formTipo) {
                ...
                $scope.submit = function () {
                    //chamar serviço API
                    /*
                    $http.post('http://192.168.43.163:11392/SGI/embalagem/', 
                    $scope.embalagem                        
